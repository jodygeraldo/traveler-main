	...
	Infix: {
		'=': [
			...
			},
			{
				...
				args: [
					{
						typeId: '90631bb7-d556-11ec-b4da-9311ba06318f',
						optional: false,
						setoftype: false,
						variadic: false,
					},
			...
			},
			{
				...
				args: [
					...
					{
						typeId: '8952ff10-d556-11ec-9115-0d4ab401dfa8',
						optional: false,
						setoftype: false,
						variadic: false,
					},
	...
	$.TypeSet<
		...
		$.cardinalityUtil.multiplyCardinalities<
			$.cardinalityUtil.optionalParamCardinality<
				_.castMaps.literalToTypeSet<P1>
			>,
			$.cardinalityUtil.optionalParamCardinality<
 ...
 * Logical negation.
 */
function op<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$bool>>>(
	op: 'not',
	v: P1
): $.$expr_Operator<
	'not',
 ...
 * Arithmetic addition.
 */
function op<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>>(
	op: '+',
	l: P1
): $.$expr_Operator<
	'+',
 ...
 * Arithmetic addition.
 */
function op<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$bigint>>>(
	op: '+',
	l: P1
): $.$expr_Operator<
	'+',
 ...
 */
function op<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$duration>>>(
	op: '-',
	v: P1
): $.$expr_Operator<
	'-',
 ...
 */
function op<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>>(
	op: 'exists',
	s: P1
): $.$expr_Operator<
	'exists',
...
function op(...args: any[]) {
	...
	if (!defs) {
		throw new Error(
			`No operator exists with signature: ${args
				.map((arg) => `${arg}`)
				.join(', ')}`
		)
	}
