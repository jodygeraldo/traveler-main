...
const $anyscalar: $anyscalar = $.makeType<$anyscalar>(
  _.spec,
  '894d3142-d556-11ec-b893-1194cedc05fb',
  _.syntax.literal
)
...
const $anyreal: $anyreal = $.makeType<$anyreal>(
  _.spec,
  '895252c9-d556-11ec-8174-9d051247dbfb',
  _.syntax.literal
)
...
const $anyfloat: $anyfloat = $.makeType<$anyfloat>(
  _.spec,
  '89559873-d556-11ec-8ed0-67e6592024b1',
  _.syntax.literal
)
...
const $anyint: $anyint = $.makeType<$anyint>(
  _.spec,
  '8952ff10-d556-11ec-9115-0d4ab401dfa8',
  _.syntax.literal
)
...
const $anynumeric: $anynumeric = $.makeType<$anynumeric>(
  _.spec,
  '89578f8a-d556-11ec-8d9e-fbfed223f5c9',
  _.syntax.literal
)
...
const datetime: $.scalarTypeWithConstructor<$datetime, never> = $.makeType<
  $.scalarTypeWithConstructor<$datetime, never>
...
const duration: $.scalarTypeWithConstructor<$duration, never> = $.makeType<
  $.scalarTypeWithConstructor<$duration, never>
...
const json: $.scalarTypeWithConstructor<$json, any> = $.makeType<
  $.scalarTypeWithConstructor<$json, any>
...
const $sequence: $sequence = $.makeType<$sequence>(
  _.spec,
  '895a04e5-d556-11ec-bd7e-9fc97b891df2',
  _.syntax.literal
)
...
const $BaseObject = $.makeType<$BaseObject>(
  _.spec,
  '90631bb7-d556-11ec-b4da-9311ba06318f',
  _.syntax.literal
)
...
const BaseObject: $.$expr_PathNode<
  ...
  null,
  true
> = _.syntax.$PathNode($.$toSet($BaseObject, $.Cardinality.Many), null, true)

export type $Object_906a01bad55611ec888b072cfc45e0d2λShape = $.typeutil.flatten<
  $BaseObjectλShape & {}
>
type $Object_906a01bad55611ec888b072cfc45e0d2 = $.ObjectType<
  'std::Object',
  $Object_906a01bad55611ec888b072cfc45e0d2λShape,
  null
>
export type $Object = $Object_906a01bad55611ec888b072cfc45e0d2
const $Object_906a01bad55611ec888b072cfc45e0d2 =
  $.makeType<$Object_906a01bad55611ec888b072cfc45e0d2>(
    _.spec,
    '906a01ba-d556-11ec-888b-072cfc45e0d2',
    _.syntax.literal
  )

const Object_906a01bad55611ec888b072cfc45e0d2: $.$expr_PathNode<
  $.TypeSet<$Object_906a01bad55611ec888b072cfc45e0d2, $.Cardinality.Many>,
  null,
  true
> = _.syntax.$PathNode(
  $.$toSet($Object_906a01bad55611ec888b072cfc45e0d2, $.Cardinality.Many),
  null,
  true
)
...
const $FreeObject = $.makeType<$FreeObject>(
  _.spec,
  '90724fa2-d556-11ec-9514-e7f6471249f9',
  _.syntax.literal
)
...
const FreeObject: $.$expr_PathNode<
  ...
  null,
  true
> = _.syntax.$PathNode($.$toSet($FreeObject, $.Cardinality.One), null, true)
...
> = $.$expr_Function<
  ...
  $.TypeSet<
    ...
    $.cardinalityUtil.overrideUpperBound<
      _.castMaps.literalToTypeSet<P1>['__cardinality__'],
      'One'
    >
  >
>
...
function assert_single<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>
>(input: P1): assert_singleλFuncExpr<P1>
...
function assert_exists<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>
>(input: P1): assert_existsλFuncExpr<P1>
...
function assert_distinct<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>
>(input: P1): assert_distinctλFuncExpr<P1>
...
function min(...args: any[]) {
  const {
  ...
  } = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {
      args: [
        {
          typeId: '895252c9-d556-11ec-8174-9d051247dbfb',
          optional: false,
          setoftype: true,
          variadic: false,
        },
      ],
      returnTypeId: '895252c9-d556-11ec-8174-9d051247dbfb',
      returnTypemod: 'OptionalType',
      preservesOptionality: true,
    },
    {
      args: [
        {
          typeId: '895ab1b5-d556-11ec-9ec3-8126a8afe6c7',
          optional: false,
          setoftype: true,
          variadic: false,
        },
      ],
      returnTypeId: '895ab1b5-d556-11ec-9ec3-8126a8afe6c7',
      returnTypemod: 'OptionalType',
      preservesOptionality: true,
    },
    {
...
> = $.$expr_Function<
  ...
  $.TypeSet<
    ...
    $.cardinalityUtil.multiplyCardinalities<
      _.castMaps.literalToTypeSet<P1>['__cardinality__'],
      _.castMaps.literalToTypeSet<P2>['__cardinality__']
    >
  >
>
/**
  ...
  $.TypeSet<
    ...
    $.cardinalityUtil.multiplyCardinalities<
      ...
      $.cardinalityUtil.optionalParamCardinality<
        _.castMaps.literalToTypeSet<P3>
      >
    >
  >
>
  ...
  $.TypeSet<
    ...
    $.cardinalityUtil.overrideLowerBound<
      $.cardinalityUtil.multiplyCardinalities<
        ...
        >,
        $.cardinalityUtil.optionalParamCardinality<
          _.castMaps.literalToTypeSet<NamedArgs['default']>
        >
      >,
      'Zero'
    >
        ...
        $.cardinalityUtil.multiplyCardinalities<
          ...
          $.cardinalityUtil.multiplyCardinalitiesVariadic<
            $.cardinalityUtil.paramArrayCardinality<
              _.castMaps.mapLiteralToTypeSet<P2>
            >
          >
        >,
        $.cardinalityUtil.optionalParamCardinality<
    ...
    $.cardinalityUtil.multiplyCardinalities<
      $.cardinalityUtil.multiplyCardinalities<
        $.cardinalityUtil.multiplyCardinalities<
          ...
          _.castMaps.literalToTypeSet<P2>['__cardinality__']
        >,
        _.castMaps.literalToTypeSet<P3>['__cardinality__']
      >,
      $.cardinalityUtil.optionalParamCardinality<
...
> = $.$expr_Function<
  ...
  $.TypeSet<
    ...
    $.cardinalityUtil.multiplyCardinalities<
      _.castMaps.literalToTypeSet<P1>['__cardinality__'],
      $.cardinalityUtil.optionalParamCardinality<
        _.castMaps.literalToTypeSet<P2>
      >
    >
  >
>
...
function to_str<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>> | undefined
>(i: P1, fmt?: P2): to_strλFuncExpr3<P1, P2>
/**
 * Return string representation of the input value.
 */
function to_str<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bigint>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>> | undefined
>(d: P1, fmt?: P2): to_strλFuncExpr4<P1, P2>
/**
 * Return string representation of the input value.
 */
function to_str<
  P1 extends $.TypeSet<$.ArrayType<$str>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>
>(array: P1, delimiter: P2): to_strλFuncExpr5<P1, P2>
/**
 * Return string representation of the input value.
 */
function to_str<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$json>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>> | undefined
>(json: P1, fmt?: P2): to_strλFuncExpr6<P1, P2>
/**
 * Return string representation of the input value.
 */
function to_str<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_datetime>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>> | undefined
>(dt: P1, fmt?: P2): to_strλFuncExpr7<P1, P2>
/**
 * Return string representation of the input value.
 */
function to_str<
...
function to_str<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$relative_duration>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>> | undefined
>(rd: P1, fmt?: P2): to_strλFuncExpr10<P1, P2>
/**
 * Return string representation of the input value.
 */
function to_str<
        ...
        $.cardinalityUtil.multiplyCardinalities<
          $.cardinalityUtil.multiplyCardinalities<
            $.cardinalityUtil.multiplyCardinalities<
              ...
              _.castMaps.literalToTypeSet<P3>['__cardinality__']
            >,
            _.castMaps.literalToTypeSet<P4>['__cardinality__']
          >,
          _.castMaps.literalToTypeSet<P5>['__cardinality__']
        >,
...
function to_datetime<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_datetime>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>
>(local: P1, zone: P2): to_datetimeλFuncExpr3<P1, P2>
/**
 * Create a `datetime` value.
 */
function to_datetime<
...
function to_datetime<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$decimalλICastableTo>>
>(epochseconds: P1): to_datetimeλFuncExpr5<P1>
  ...
  $.TypeSet<
    ...
    $.cardinalityUtil.multiplyCardinalities<
      $.cardinalityUtil.multiplyCardinalities<
        $.cardinalityUtil.multiplyCardinalities<
          $.cardinalityUtil.optionalParamCardinality<
            _.castMaps.literalToTypeSet<NamedArgs['hours']>
          >,
          $.cardinalityUtil.optionalParamCardinality<
            _.castMaps.literalToTypeSet<NamedArgs['minutes']>
          >
        >,
        $.cardinalityUtil.optionalParamCardinality<
          _.castMaps.literalToTypeSet<NamedArgs['seconds']>
        >
      >,
      $.cardinalityUtil.optionalParamCardinality<
...
function sequence_reset(...args: any[]) {
  const {
  ...
  } = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {
      args: [
        {
          typeId: '9447bc01-d556-11ec-82be-d90083425a50',
          optional: false,
          setoftype: false,
          variadic: false,
        },
...
export {
  ...
  $BaseObject,
  BaseObject,
  $Object_906a01bad55611ec888b072cfc45e0d2,
  Object_906a01bad55611ec888b072cfc45e0d2,
  $FreeObject,
  FreeObject,
}
