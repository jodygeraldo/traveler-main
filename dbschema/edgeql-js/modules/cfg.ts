...
const AllowBareDDL: $AllowBareDDL = $.makeType<$AllowBareDDL>(
  _.spec,
  '98c38536-d556-11ec-95c1-8b0eb5c35864',
  _.syntax.literal
)

export type $memory = $.ScalarType<'cfg::memory', _.edgedb.ConfigMemory, true>
const memory: $.scalarTypeWithConstructor<$memory, never> = $.makeType<
  $.scalarTypeWithConstructor<$memory, never>
...
const $ConfigObject = $.makeType<$ConfigObject>(
  _.spec,
  '9826eeca-d556-11ec-bf68-1b6406c71001',
  _.syntax.literal
)
...
const ConfigObject: $.$expr_PathNode<
  ...
  null,
  true
> = _.syntax.$PathNode($.$toSet($ConfigObject, $.Cardinality.Many), null, true)
...
const $AbstractConfig = $.makeType<$AbstractConfig>(
  _.spec,
  '98e63c22-d556-11ec-8990-b54fa361c828',
  _.syntax.literal
)
...
const $Auth = $.makeType<$Auth>(
  _.spec,
  '98c50350-d556-11ec-b11b-3bae56ff69f7',
  _.syntax.literal
)
...
const Auth: $.$expr_PathNode<
  ...
  null,
  true
> = _.syntax.$PathNode($.$toSet($Auth, $.Cardinality.Many), null, true)
...
const $AuthMethod = $.makeType<$AuthMethod>(
  _.spec,
  '983604e7-d556-11ec-b351-2fd1cd651746',
  _.syntax.literal
)
...
const AuthMethod: $.$expr_PathNode<
  ...
  null,
  true
> = _.syntax.$PathNode($.$toSet($AuthMethod, $.Cardinality.Many), null, true)
...
const $Config = $.makeType<$Config>(
  _.spec,
  '991b44be-d556-11ec-9ecb-cdb05513c16c',
  _.syntax.literal
)
...
const Config: $.$expr_PathNode<
  ...
  null,
  true
> = _.syntax.$PathNode($.$toSet($Config, $.Cardinality.Many), null, true)
...
const $DatabaseConfig = $.makeType<$DatabaseConfig>(
  _.spec,
  '998a1c9e-d556-11ec-be34-433c8c4a659d',
  _.syntax.literal
)
...
const $InstanceConfig = $.makeType<$InstanceConfig>(
  _.spec,
  '9952bb96-d556-11ec-8f8e-9524e224c00b',
  _.syntax.literal
)
...
const $SCRAM = $.makeType<$SCRAM>(
  _.spec,
  '98540bad-d556-11ec-9c74-5b8fa83d5afa',
  _.syntax.literal
)
...
const SCRAM: $.$expr_PathNode<
  ...
  null,
  true
> = _.syntax.$PathNode($.$toSet($SCRAM, $.Cardinality.Many), null, true)
...
const $Trust = $.makeType<$Trust>(
  _.spec,
  '9844f07d-d556-11ec-9cbb-636f3da4842a',
  _.syntax.literal
)
...
const Trust: $.$expr_PathNode<
  ...
  null,
  true
> = _.syntax.$PathNode($.$toSet($Trust, $.Cardinality.Many), null, true)
...
> = $.$expr_Function<
  ...
  $.TypeSet<
    ...
    $.cardinalityUtil.multiplyCardinalities<
      $.cardinalityUtil.optionalParamCardinality<NamedArgs['sources']>,
      $.cardinalityUtil.optionalParamCardinality<
        _.castMaps.literalToTypeSet<NamedArgs['max_source']>
      >
    >
  >
>
