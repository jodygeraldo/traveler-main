...
const TransactionIsolation: $TransactionIsolation =
	$.makeType<$TransactionIsolation>(
		_.spec,
		'9734f19b-d556-11ec-af14-a5b642d3b3da',
		_.syntax.literal
	)
...
const VersionStage: $VersionStage = $.makeType<$VersionStage>(
	_.spec,
	'9735bd5e-d556-11ec-8845-29687743757d',
	_.syntax.literal
)
...
const $SystemObject = $.makeType<$SystemObject>(
	_.spec,
	'9736778d-d556-11ec-a9a2-d7dbf7e925dc',
	_.syntax.literal
)
...
const SystemObject: $.$expr_PathNode<
	...
	null,
	true
> = _.syntax.$PathNode($.$toSet($SystemObject, $.Cardinality.Many), null, true)

export type $DatabaseλShape = $.typeutil.flatten<
	$SystemObjectλShape &
		_schema.$AnnotationSubjectλShape & {
			name: $.PropertyDesc<
				_std.$str,
...
const $Database = $.makeType<$Database>(
	_.spec,
	'975de3a6-d556-11ec-8e4d-c3513e265aec',
	_.syntax.literal
)
...
const Database: $.$expr_PathNode<
	...
	null,
	true
> = _.syntax.$PathNode($.$toSet($Database, $.Cardinality.Many), null, true)
...
const $ExtensionPackage = $.makeType<$ExtensionPackage>(
	_.spec,
	'978a2713-d556-11ec-93db-b9c3935d1483',
	_.syntax.literal
)
...
const $Role = $.makeType<$Role>(
	_.spec,
	'97bc2eea-d556-11ec-88ee-d392a83cc059',
	_.syntax.literal
)
...
const Role: $.$expr_PathNode<
	...
	null,
	true
> = _.syntax.$PathNode($.$toSet($Role, $.Cardinality.Many), null, true)
