...
export type $local_date = $.ScalarType<
  'cal::local_date',
  _.edgedb.LocalDate,
  true
>
const local_date: $.scalarTypeWithConstructor<$local_date, never> = $.makeType<
  $.scalarTypeWithConstructor<$local_date, never>
>(_.spec, '00000000-0000-0000-0000-00000000010c', _.syntax.literal)

export type $local_datetime = $.ScalarType<
  'cal::local_datetime',
  _.edgedb.LocalDateTime,
  true
>
const local_datetime: $.scalarTypeWithConstructor<$local_datetime, never> =
  $.makeType<$.scalarTypeWithConstructor<$local_datetime, never>>(
    _.spec,
    '00000000-0000-0000-0000-00000000010b',
    _.syntax.literal
  )

export type $local_time = $.ScalarType<
  'cal::local_time',
  _.edgedb.LocalTime,
  true
>
const local_time: $.scalarTypeWithConstructor<$local_time, never> = $.makeType<
  $.scalarTypeWithConstructor<$local_time, never>
>(_.spec, '00000000-0000-0000-0000-00000000010d', _.syntax.literal)

export type $relative_duration = $.ScalarType<
  'cal::relative_duration',
  _.edgedb.RelativeDuration,
  true
>
const relative_duration: $.scalarTypeWithConstructor<
  $relative_duration,
  never
> = $.makeType<$.scalarTypeWithConstructor<$relative_duration, never>>(
  _.spec,
...
function to_local_datetime(...args: any[]) {
  const {
    ...
    args: positionalArgs,
    namedArgs,
  } = _.syntax.$resolveOverload('cal::to_local_datetime', args, _.spec, [
    {
      args: [
        {
...
function to_local_date(...args: any[]) {
  const {
    ...
    args: positionalArgs,
    namedArgs,
  } = _.syntax.$resolveOverload('cal::to_local_date', args, _.spec, [
    {
      args: [
        {
          typeId: '00000000-0000-0000-0000-000000000101',
...
function to_local_time(...args: any[]) {
  const {
    ...
    args: positionalArgs,
    namedArgs,
  } = _.syntax.$resolveOverload('cal::to_local_time', args, _.spec, [
    {
      args: [
        {
          typeId: '00000000-0000-0000-0000-000000000101',
...
function time_get(...args: any[]) {
  const {
    ...
    args: positionalArgs,
    namedArgs,
  } = _.syntax.$resolveOverload('cal::time_get', args, _.spec, [
    {
      args: [
        {
...
function date_get(...args: any[]) {
  const {
    ...
    args: positionalArgs,
    namedArgs,
  } = _.syntax.$resolveOverload('cal::date_get', args, _.spec, [
    {
      args: [
        {
        ...
        $.cardinalityUtil.multiplyCardinalities<
          $.cardinalityUtil.multiplyCardinalities<
            $.cardinalityUtil.multiplyCardinalities<
              $.cardinalityUtil.multiplyCardinalities<
                $.cardinalityUtil.optionalParamCardinality<
                  _.castMaps.literalToTypeSet<NamedArgs['years']>
                >,
                $.cardinalityUtil.optionalParamCardinality<
                  _.castMaps.literalToTypeSet<NamedArgs['months']>
                >
              >,
              $.cardinalityUtil.optionalParamCardinality<
                _.castMaps.literalToTypeSet<NamedArgs['days']>
              >
            >,
            $.cardinalityUtil.optionalParamCardinality<
...
function to_relative_duration(...args: any[]) {
  const {
    ...
    args: positionalArgs,
    namedArgs,
  } = _.syntax.$resolveOverload('cal::to_relative_duration', args, _.spec, [
    {
      args: [],
      namedArgs: {
        years: {
