...
> = $.$expr_Function<
  ...
  $.TypeSet<
    _std.$number,
    $.cardinalityUtil.overrideLowerBound<$.Cardinality.One, 'Zero'>
  >
>
...
function var_9726e13fd55611ec82b659f9ae66a691<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>
>(vals: P1): var_9726e13fd55611ec82b659f9ae66a691λFuncExpr<P1>
/**
 * Return the sample variance of the input set.
 */
function var_9726e13fd55611ec82b659f9ae66a691<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>
>(vals: P1): var_9726e13fd55611ec82b659f9ae66a691λFuncExpr2<P1>
...
> = $.$expr_Function<
  ...
  $.TypeSet<
    ...
    $.cardinalityUtil.multiplyCardinalities<
      ...
      _.castMaps.literalToTypeSet<NamedArgs['base']>['__cardinality__']
    >
  >
>
/**
