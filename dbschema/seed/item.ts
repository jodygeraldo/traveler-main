...
const commonMaterial = [
  ...
  { name: "Inspector's Sacrificial Knife", rarity: 4, group: 'Sacrificial Knifes' },
  { name: "Agent's Sacrificial Knife", rarity: 3, group: 'Sacrificial Knifes' },
  { name: "Hunter's Sacrificial Knife", rarity: 2, group: 'Sacrificial Knifes' },
  ...
  { name: 'Golden Raven Insignia', rarity: 3, group: 'Treasure Hoarder Insignias' },
  { name: 'Silver Raven Insignia', rarity: 2, group: 'Treasure Hoarder Insignias' },
  { name: 'Treasure Hoarder Insignia', rarity: 1, group: 'Treasure Hoarder Insignias' },
...
const talentBossMaterial = [
  ...
  { name: 'Tusk of Monoceros Caeli', rarity: 5, group: 'Enter the Golden House' },
  { name: 'Shard of a Foul Legacy', rarity: 5, group: 'Enter the Golden House' },
  { name: 'Shadow of the Warrior', rarity: 5, group: 'Enter the Golden House' },
  { name: "Dragon Lord's Crown", rarity: 5, group: 'Beneath the Dragon-Queller' },
  ...
  { name: 'Hellfire Butterfly', rarity: 5, group: 'Narukami Island: Tenshukaku' },
  { name: 'Mudra of the Malefic General', rarity: 5, group: 'End of the Oneiric Euthymia' },
  { name: 'Tears of the Calamitous God', rarity: 5, group: 'End of the Oneiric Euthymia' },
  { name: 'The Meaning of Aeons', rarity: 5, group: 'End of the Oneiric Euthymia' },
]
