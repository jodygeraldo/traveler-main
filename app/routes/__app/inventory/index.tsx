...
export default function InventoryPage() {
  ...
  return (
    <div className="space-y-12">
      ...
      <div>
        <h2 className="text-lg font-medium leading-6 text-primary-12">Ascension Gem</h2>
        <ItemList items={items.ascensionGem} category="ascension_gem" />
      </div>

      <div>
        <h2 className="text-lg font-medium leading-6 text-primary-12">Ascension Boss</h2>
        <ItemList items={items.ascensionBoss} category="ascension_boss" />
      </div>

      <div>
        <h2 className="text-lg font-medium leading-6 text-primary-12">Local Specialty</h2>
        <ItemList items={items.localSpecialty} category="local_specialty" />
      </div>

      <div>
        <h2 className="text-lg font-medium leading-6 text-primary-12">Talent Book</h2>
        <ItemList items={items.talentBook} category="talent_book" />
      </div>

      <div>
        <h2 className="text-lg font-medium leading-6 text-primary-12">Talent Boss</h2>
        <ItemList items={items.talentBoss} category="talent_boss" />
      </div>

      <div>
        <h2 className="text-lg font-medium leading-6 text-primary-12">Special</h2>
